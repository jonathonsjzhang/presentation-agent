...
严格输出 `storyline.v2`，包括 topic、audience、report_type、output_format、objective、message_pyramid、ordering_rationale、closing_intent、title_read_test、pages、appendix_plan 和 open_questions。
