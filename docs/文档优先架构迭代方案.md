...
> 状态：核心实现已完成，v0.3 保持显式启用，进入 golden E2E 验收  
> 建议版本：`v0.3`  
> 日期：2026-07-02  
...
默认仍保持 `legacy.v0_2`。完成三类 golden case 的真实模型 E2E、视觉验收和
回滚演练后，再修改 `active_contract_profile`。
...
skills/format_report/schemas/formatted_material.v2.json
tests/fixtures/v0_3/
```
