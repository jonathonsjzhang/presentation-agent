...
class PipelineTests(unittest.TestCase):
    ...
    def test_auto_pipeline_runs_all_seven_stages(self) -> None:
        ...
        self.assertEqual(summary["stages"][0]["agent_id"], "task_positioning")
        if summary["status"] == "completed":
            self.assertEqual(len(summary["stages"]), 7)
...
def _expected_schema(agent_id: str) -> str:
    return {
        ...
        "storyline_design": "storyline.v1",
        "page_filling": "page_content.v1",
